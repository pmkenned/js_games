...
textures.push(blue_creature_tex);
...
textures.push(blue_creature_down_tex);
...
textures.push(blue_creature_left_tex);
...
textures.push(blue_creature_right_tex);
...
textures.push(boot_flipper_tex);
...
textures.push(border_empty_tex);
...
textures.push(button_big_brown_tex);
...
textures.push(button_big_cyan_tex);
...
textures.push(button_big_gray_tex);
...
textures.push(button_brown_tex);
...
textures.push(button_green_tex);

const button_red_tex = new Image();
button_red_tex.src = "data:image/png;base64,";
textures.push(button_red_tex);
...
textures.push(ice_tex);

const ice_ll_tex = new Image();
ice_ll_tex.src = "data:image/png;base64,";
textures.push(ice_ll_tex);

const ice_ul_tex = new Image();
ice_ul_tex.src = "data:image/png;base64,";
textures.push(ice_ul_tex);
...
textures.push(missile_shooter_tex);
...
textures.push(monster_back_tex);
...
textures.push(monster_front_tex);
...
textures.push(monster_left_tex);
...
textures.push(monster_right_tex);
...
textures.push(player_front_tex);
...
textures.push(player_ice_back_tex);
...
textures.push(player_ice_front_tex);
...
textures.push(player_ice_left_tex);
...
textures.push(player_ice_right_tex);
...
textures.push(player_right_tex);
